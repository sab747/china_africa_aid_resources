...
{'timezones': ['Africa/Brazzaville'], 'code': 'CG', 'continent': 'Africa', 'name': 'Congo', 'capital': 'Brazzaville'},
...
{'timezones': ['Africa/Khartoum'], 'code': 'SD', 'continent': 'Africa', 'name': 'South Sudan', 'capital': 'Juba'},
...
{'timezones': ['Africa/Sao_Tome'], 'code': 'ST', 'continent': 'Africa', 'name': 'Sao Tome and Principe', 'capital': 'Sao Tome and Principe'},
...
for country in countries_list:
    if country['continent'] == 'Africa':
        africa_countries.append(country['name'])

for country in countries_list:
    if country['continent'] == 'Asia':
        asia_countries.append(country['name'])

for country in countries_list:
    if country['continent'] == 'Europe':
        europe_countries.append(country['name'])

for country in countries_list:
    if country['continent'] == 'Oceania':
        oceania_countries.append(country['name'])

for country in countries_list:
    if country['continent'] == 'North America':
        northamerica_countries.append(country['name'])

for country in countries_list:
    if country['continent'] == 'South America':
        southamerica_countries.append(country['name'])
